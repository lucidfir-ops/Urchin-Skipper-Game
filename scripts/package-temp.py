...
parser.add_argument('--label', default='September 24 coasting and traffic feedback', help='Human-readable build identity')
...
5. Check the title reads TEMP · SEP 24 · COASTING & TRAFFIC.
