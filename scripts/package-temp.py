...
parser.add_argument('--label', default='September 25 coasts and safety feedback', help='Human-readable build identity')
...
5. Check the title reads TEMP · SEP 25 · COASTS & SAFETY.
